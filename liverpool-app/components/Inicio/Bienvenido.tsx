      ...
      <div className="bg-gradient-to-r from-white via-white to-pink-300">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7 ">
            <h1 className="max-w-2xl mb-4 text-5xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-pink-900">
              Bienvenido a nuestro sistema de predicción Liverpool
            </h1>
            <p className="max-w-2xl mb-6 font-light text-gray-800 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              ...
              podemos juntos cuidar y potenciar el talento de Liverpool.”
            </p>
            <a
              href="#inicio"
