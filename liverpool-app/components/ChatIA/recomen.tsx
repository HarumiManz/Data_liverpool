      ...
      <section className=" dark:bg-gray-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          ...
          <div className="bg-gradient-to-t from-white via-pink-200 to-white space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            <div className="overflow-hidden pt-5 lg:pt-[1%] hover:scale-110 transition-all duration-200  flex flex-col p-6 mx-auto max-w-lg text-center text-pink-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              <h3 className="mb-4 text-2xl font-semibold">
                Puestos con más renuncias
              </h3>
              <p className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
                Los principales puestos con más renuncias que encontramos
            ...
            <div className="overflow-hidden pt-5 lg:pt-[1%] hover:scale-110 transition-all duration-200 flex flex-col p-6 mx-auto max-w-lg text-center text-pink-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <ul role="list" className="pt-5 mb-8 space-y-4 text-left">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span className="font-semibold">ENPS</span>{" "}
                  <span>(employee net promoter score) </span>
                </li>
                <li className="flex items-center space-x-3">
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-pink-500 dark:text-pink-400"
                  ...
                  <span>Horarios de entrada y salida: </span>
                </li>
                <li className="flex items-center space-x-3">
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-pink-500 dark:text-pink-400"
            ...
            <div className="overflow-hidden pt-5 lg:pt-[1%] hover:scale-110 transition-all duration-200 flex flex-col p-6 mx-auto max-w-lg text-center text-pink-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              ...
              <ul role="list" className="pt-10 mb-8 space-y-4 text-left">
                <li className="flex items-center space-x-3">
                  ...
                  <span>Esquema de compensación variable </span>
                </li>
                <li className="flex items-center space-x-3">
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-pink-500 dark:text-pink-400"
                  ...
                  <span>Incentivos personalizados</span>
                </li>
                <li className="flex items-center space-x-3">
                  <svg
                    className="flex-shrink-0 w-5 h-5 text-pink-500 dark:text-pink-400"
